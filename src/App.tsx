      ...
      <main className="bg-white rounded-[2rem] shadow-soft max-w-6xl w-full h-auto md:min-h-[600px] flex flex-col md:flex-row overflow-hidden border border-white">
        ...
        <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center relative bg-white z-20">
            ...
            <div className="mt-8 md:mt-0 space-y-6">
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-brand-dark leading-none">
                    TALOS<br />SYSTEMS
                </h1>
                <p className="text-lg text-brand-muted max-w-md leading-relaxed">
                    Advanced neural architecture for the next generation of autonomous computing. Secure, scalable, and sentient-ready.
                </p>
                <div className="pt-4">
                    <button className="bg-brand-dark text-white px-8 py-4 rounded-full font-bold hover:bg-opacity-90 transition-all transform hover:scale-105 active:scale-95 shadow-lg">
                        Initialize Core
                    </button>
                </div>
            </div>
